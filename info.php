...
include("connect.php");
$acc=$_POST['acc'];
$disi=mysqli_num_rows($dis=mysqli_query($conn,"select * from class where email='$acc'"));
if($disi>0)
{
echo"<center><h3 style='margin-top:-50px;color:green;'>Student informations</h3><br><br>";
