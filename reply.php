...
$sql=mysqli_query($conn,"SELECT * FROM contact where id='$se'");
  ...
  while($row1 = mysqli_fetch_array($sql1)){
  	$df=$row1['fname'];
  	$dg=$row1['lname'];
                echo "<div style='background-color:grey;margin-top:-0.3cm;width:7cm;'>Message from $df $dg </div> <br><section style='width:5cm;background-color:blue;border-radius:75px 75px 0px ;height:2cm;color:white'>". $emd. "</section><br>";
        }        
    }
?>
